...
const Yeezy700V2 = (props) => {
  ...
  const [shoeData, setShoeData] = useState({
    ...
    size: null,
    description:
      "The YEEZY BOOST 700 V2 features an upper composed of roller knit and premium leather with nubuck overlays with reflective details throughout. The full-length drop in boost midsole provides comfort and stability.",
    quantity: 1,
  });
    ...
    <div className="container mt-5">
      ...
      <div className="row">
        <div className="col-md-6">
          <img src="https://preview.thenewsmarket.com/Previews/ADID/StillAssets/320x320/558185.jpg" />
        </div>
