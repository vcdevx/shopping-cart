    ...
    <div className="container mt-5">
      ...
      <div className="row">
        <div className="col-md-6">
          <img src="https://preview.thenewsmarket.com/Previews/ADID/StillAssets/320x320/600865.jpg" />
        </div>
